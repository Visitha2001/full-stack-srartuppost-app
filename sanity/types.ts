...
// Query: *[_type == "startup" && defined(slug.current) && (    !defined($search) ||    title match $search + "*" ||    description match $search + "*" ||    category match $search + "*" ||    author->name match $search  )] | order(_createdAt desc) {    _id,    title,    slug,    _createdAt,    author -> {        _id, name, username, slug, image, bio    },    views,    description,    category,    image  }
...
// Query: *[_type == "startup" && author._ref == $id] | order(_createdAt desc){    _id,    title,    slug,    _createdAt,    author -> {        _id, name, username, slug, image, bio    },    views,    description,    category,    image  }
